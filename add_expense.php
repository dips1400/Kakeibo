...
if (isset($_POST['add'])) {
    ...
    $expenses = "INSERT INTO expenses (userid, expense,expensedate,expensecategory) VALUES ('$userid', '$expenseamount','$expensedate','$expensecategory')";
    $result = mysqli_query($conn, $expenses) or die("Something Went Wrong!");
...
if (isset($_POST['update'])) {
    ...
    $sql = "UPDATE expenses SET expense='$expenseamount', expensedate='$expensedate', expensecategory='$expensecategory' WHERE userid='$userid' AND expense_id='$id'";
...
if (isset($_POST['delete'])) {
    ...
    $sql = "DELETE FROM expenses WHERE userid='$userid' AND expense_id='$id'";
    if (mysqli_query($conn, $sql)) {
        echo "Records were updated successfully.";
    } else {
        echo "ERROR: Could not able to execute $sql. " . mysqli_error($conn);
...
if (isset($_GET['edit'])) {
    $id = $_GET['edit'];
    $update = true;
    $record = mysqli_query($conn, "SELECT * FROM expenses WHERE userid='$userid' AND expense_id=$id");
...
<body>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-right" id="sidebar-wrapper">
            ...
            <div class="sidebar-heading">Kakeibo</div>
