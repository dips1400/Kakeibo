<?php
include("session.php");
$exp_fetched = mysqli_query($conn, "SELECT * FROM expenses WHERE userid = '$userid'");

if (isset($_POST['save'])) {
    $user_firstname = $_POST['user_firstname'];
    $user_lastname = $_POST['user_lastname'];

    $sql = "UPDATE user SET user_firstname = '$user_firstname', user_lastname='$user_lastname' WHERE userid='$userid'";
...
if (isset($_POST['but_upload'])) {
    ...
    if (in_array($imageFileType, $extensions_arr)) {
        ...
        // Insert record
       /* $query = "insert into user(profile_path) values('$name')";
